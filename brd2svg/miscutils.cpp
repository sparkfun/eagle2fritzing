...
void MiscUtils::calcTextAngle(int align, qreal & angle, int mirror, int spin, qreal size, qreal & x, qreal & y, bool & anchorAtStart, QString &horiz, QString &vert)
{
    bool anchorAtTop;
